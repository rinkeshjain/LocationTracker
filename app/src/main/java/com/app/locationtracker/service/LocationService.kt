 ...
 */
package com.app.locationtracker.service
...
import com.app.locationtracker.activity.FirstActivity
import com.app.locationtracker.util.toText
...
viewModel.insert(currentLocation)
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        val launchActivityIntent = Intent(this, FirstActivity::class.java)
        ...
        return notificationCompatBuilder
            ...
            .addAction(
                R.drawable.ic_launch, getString(
    ...
    companion object {
        ...
        private const val NOTIFICATION_CHANNEL_ID = "location_tracker"
    }
}
